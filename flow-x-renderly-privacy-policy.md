...
## Data we collect
The developer collects **no** user data. The extension has no analytics,
no telemetry, and no server of its own.

## Data the extension handles
- **Settings** (backend URL, selected channel, master prompt, auto-dock
...
initiate (filling prompts, reading images you ask it to save). No data
is shared with the developer or any third party.

## Contact
For questions about this policy, contact: [koogunyemi@gmail.com]